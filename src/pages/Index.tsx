...
const welcomeTranslations = {
  ...
  copyright: {
    en: "© 2024 Agri Assist. All rights reserved.",
    hi: "© 2024 कृषि सहायक. सर्वाधिकार सुरक्षित।",
    te: "© 2024 వ్యవసాయ సహాయకుడు. అన్ని హక్కులు రిజర్వ్ చేయబడ్డాయి.",
    kn: "© 2024 ಕೃಷಿ ಸಹಾಯಕ. ಎಲ್ಲಾ ಹಕ್ಕುಗಳನ್ನು ಕಾಯ್ದಿರಿಸಲಾಗಿದೆ.",
    ml: "© 2024 കൃഷി സഹായി. എല്ലാ അവകാശങ്ങളും നിക്ഷിപ്തമാണ്.",
  },
  loading: {
    en: "Loading...",
    hi: "लोड हो रहा है...",
